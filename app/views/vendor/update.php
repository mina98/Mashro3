...
<div class='form-group'>
  <label class='col-md-4 control-label'>unit price</label>  
    ...
    <div class='input-group'>
        ...
        <input name='unitPrice' type='text' placeholder='unit price' class='form-control'  type='text' value='{$_SESSION['UNITPRICE']}' >
    </div>
  </div>
</div>
...
<div class='form-group'>
  <label class='col-md-4 control-label'>Description</label>  
    ...
    <div class='input-group'>
        <span class='input-group-addon'><i class='glyphicon-oi glyphicon-envelope'></i></span>
        <textarea name='description' class='form form-control' placeholder='item description here please' >{$_SESSION['DESCREPTION']}</textarea>
